...
const menuBtn = { padding:"5px 10px", borderRadius:3, border:"none", background:"transparent", cursor:"pointer", color:"#1a1614", fontFamily:"'Courier New',monospace", fontSize:11, textAlign:"left", letterSpacing:0.3 };import { useState, useEffect, useRef } from "react";
import { createClient } from '@supabase/supabase-js';
